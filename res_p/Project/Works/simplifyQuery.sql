...
is
	...
	cursor curWithSim is
     ...
     SELECT m_name  from   
	((SELECT m_name From menu1 m inner join orders1  o on  o.m_id=m.m_id  WHERE o.o_date='25-jan-2019' ) Union
	(SELECT m_name From menu2 m inner join orders2  o on  o.m_id=m.m_id  WHERE o.o_date='25-jan-2019' ));
